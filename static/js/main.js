...
(function($) {
    ...
    $(function() {
        ...
        if ($("html").hasClass("one-page-layout")) {
            ...
            $(".blog-single").each(function(index, element) {
                var menu_link = $(this);
                var file_url = menu_link.attr("href");
                var slug = menu_link.data("slug");
                menu_link.attr("href", "#/" + slug);
        ...
        if ($(".lightbox, .gallery, .wp-block-gallery").length) {
            $(".media-box, .gallery, .wp-block-gallery").each(function(index, element) {
                ...
                $media_box.magnificPopup({
                    delegate: '.lightbox, figure a[href$=".jpg"], figure a[href$=".jpeg"], figure a[href$=".png"], figure a[href$=".gif"], .gallery-item a[href$=".jpg"], .gallery-item a[href$=".jpeg"], .gallery-item a[href$=".png"], .gallery-item a[href$=".gif"]',
                    type: "image",
                    image: {
